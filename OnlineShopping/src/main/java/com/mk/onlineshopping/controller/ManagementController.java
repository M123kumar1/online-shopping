...
import com.mk.onlineshopping.util.FileUploadUtility;
import com.mk.onlineshopping.validator.ProductValidator;
...
public class ManagementController {
	...
	public ModelAndView showManageProducts(@RequestParam(name = "operation", required = false) String operation) {
		...
		if (operation != null) {
			if (operation.equals("product")) {
				mv.addObject("message", "Product submitted Successfily!");
			}
			else if(operation.equals("category")){
				mv.addObject("message", "Category submitted Successfily!");
			}
		}
	...
	public ModelAndView showEditProducts(@PathVariable int id) {
		...
		// set the product hetched from data base
		mv.addObject("product", nProduct);

		return mv;
	}

	// handlig product submission
